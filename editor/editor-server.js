...
const { updateHomepage } = require(path.join(__dirname, '..', 'scripts', 'update-homepage.js'));
const { generateSitemap } = require(path.join(__dirname, '..', 'scripts', 'update-sitemap.js'));
